...
<body>
	<div id="my-alert" class="alert alert-danger fade in msg1">
		...
		<button id="continue" type="button" class="btn btn-info"><a style="text-decoration:none;" href="JDDispatcherServlet?target=admin/category/addCategory.jsp">继续添加</a></button>
